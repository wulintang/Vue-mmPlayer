...
$(document).ready(function(){
	if(!browser.versions.mobile){
		...
		if(!_st)_st=0;
		var _code = '<div id="fixed" class="xiuxiu"><div id="dl"><div id="dd"><a href="https://www.taoisms.org.cn" target="_blank"><i class="icon icon-taoismsicon"></i><br>门户</a><a href="https://www.snsou.cn/" target="_blank"><i class="icon icon-snsoucn"></i><br>搜索</a><a href="https://www.zuori.net.cn/" target="_blank"><i class="icon icon-zuoritoutiao"></i><br>导航</a><a href="https://www.daoyue.org.cn/" target="_blank"><i class="icon icon-daoyueorgcn"></i><br>道乐</a><a href="https://www.yudao.org.cn/" target="_blank"><i class="icon icon-yuzhendaoyuan"></i><br>遇真</a><a href="https://www.xiudaohu.cn/" target="_blank"><i class="icon icon-taijitubiao"></i><br>百科</a><a href="https://www.chntaoism.com/" target="_blank"><i class="icon icon-xinghanlianmeng"></i><br>同盟</a><a href="https://www.zhimucishan.com/" target="_blank"><i class="icon icon-wulintangyuanxing"></i><br>慈善</a><a href="https://www.han-zu.cn/" target="_blank"><i class="icon icon-yiyannanjing"></i><br>交互</a></div><div id="dt"><a href="javascript:void(0);" id="close" class="xuanzhun"><i class="icon icon-taijitubiao"></i><br></a></div></div></div>';
		if(_st==1){
